...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $checkQuery = "SELECT * FROM room02 WHERE date = :date AND hour = :hour";
    ...
    if ($stmt->rowCount() > 0) {
        ...
        $insertQuery = "INSERT INTO room02 (employee_id, hour, date) VALUES (:employee_id, :hour, :date)";
...
<body>
    ...
    <main class="container mt-5">
        <h1 class="text-center mb-4">Reservar Sala 02</h1>

        <!-- Exibe as reservas existentes -->
        <div class="row justify-content-center">
            <div class="col-md-8">
                <h3>Reservas Existentes na Sala 02:</h3>
